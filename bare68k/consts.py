...
MEM_FC_SHIFT       = 4
MEM_FC_MASK        = 0xF0
MEM_FC_USER_DATA   = 0x50
MEM_FC_USER_PROG   = 0x60
MEM_FC_SUPER_DATA  = 0x90
MEM_FC_SUPER_PROG  = 0xa0
MEM_FC_INT_ACK     = 0x00
# masks
MEM_FC_DATA_MASK   = 0x10
MEM_FC_PROG_MASK   = 0x20
MEM_FC_USER_MASK   = 0x40
MEM_FC_SUPER_MASK  = 0x80
