...
#define MEM_FC_MASK        0x70
#define MEM_FC_USER_DATA   0x10
#define MEM_FC_USER_PROG   0x20
#define MEM_FC_SUPER_DATA  0x50
#define MEM_FC_SUPER_PROG  0x60
#define MEM_FC_INT_ACK     0x70
